...
urlpatterns = [
    ...
    path('lic-prov', LicProvController.as_view()),
    path('lic-prov/<int:id>', LicProvController.as_view()),
    ...
    path('lic-prov-rubro/<int:id>', LicProvRubroController.as_view()),
    path('lic-prov-rubro', LicProvRubroController.as_view()),
    path('lic-prov-rubro-buscar/<int:tipo>', BuscarLicProvRubroController.as_view()),
    path('lic-prov-rubro-buscar/<int:tipo>/<int:orden>', BuscarLicProvRubroController.as_view()),
    path('lic-prov-ubica', LicProvUbicaController.as_view()),
    ...
    path('lic-prov-anula', LicProvAnulaController.as_view()),
]